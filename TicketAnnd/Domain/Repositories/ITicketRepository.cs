...
public interface ITicketRepository
{
    ...
    Task<TicketPagedResultReadModel> GetPagedByCompanyIdAsync(Guid companyId, int page = 1, int pageSize = 10, Guid? teamId = null, string? status = null, Guid? categoryId = null, string? subject = null, CancellationToken cancellationToken = default);
